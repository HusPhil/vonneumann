...
function App() {
  ...
  }, [simulatorState.isRunning, simulatorState.isHalted, simulatorState.executionSpeed]);
  ...
  const handleLoadProgram = (
    ...
    memorySetup.forEach(({ address, value }) => {
      const memoryCell = newState.memory.find(cell => cell.address === address);
      if (memoryCell) {
    ...
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 p-4 md:p-6">
      <header className="max-w-7xl mx-auto mb-6">
        ...
        <p className="mt-2 text-gray-600 dark:text-gray-300 max-w-3xl">
          An interactive visual simulator demonstrating the inner workings of a CPU based on the Von Neumann architecture.
          Load a program, step through execution, and watch how data flows between components.
        </p>
      </header>
